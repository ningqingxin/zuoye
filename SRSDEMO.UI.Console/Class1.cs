...
namespace SRSDEMO.UI
{
    class SRS
    {
        ...
        //第二学期表
        public static ScheduleOfClasses scheduleOfClasses2 = new ScheduleOfClasses("SU2009");
        //教授、学生、课程列表
        ...
        static void Main(string[] args)
        {
            ...
            se1 = c1.ScheduleSection("M", "8:10 - 10:00 PM", "OMGT101", 30);
            se2 = c1.ScheduleSection("W", "6:10 - 8:00 PM", "OMGT202", 30);
            se3 = c2.ScheduleSection("Th", "4:10 - 6:00 PM", "OMGT105", 25);
            se4 = c2.ScheduleSection("Tu", "6:10 - 8:00 PM", "EDG330", 25);
            se5 = c3.ScheduleSection("M", "6:10 - 8:00 PM", "EDG101", 20);
            se6 = c4.ScheduleSection("Th", "4:10 - 6:00 PM", "LGD241", 15);
            se7 = c5.ScheduleSection("F", "4:10 - 6:00 PM", "IGS25", 40);
